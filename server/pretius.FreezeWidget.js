...
$.widget('pretius.freezeWidget', {
  ...
  C_PLUGIN_NAME      : 'Pretius Extend Classic Report',
  C_ERROR_MESSAGE : {
  ...
  _create: function(){
    ...
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'initialize widget');
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME, 'widget options', this.options);
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME, 'widget element', this.element);
    this.errorPrefix =  this.C_PLUGIN_NAME + ' ['+this.element.attr('id') + '] : ';
    this.new_raport = this.element.find('div[id*="catch"]');
    this.html_element = this.element[0];
  ...
  before_report_refresh: function( pEvent ){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'before_report_refresh');
  ...
  _add_resize_observer: function( ){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_add_resize_observer');
    let widget = this;
    ...
    myObserver.observe(this.html_element);

  }, 
  _window_resize_report: function( pEvent ){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_window_resize_report', pEvent);
  ...
  destroy: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'destroy');
  },
  _check_proper_ammount_of_columns: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_check_proper_ammount_of_columns',{'columns to freeze': this.options.number_of_columns_to_freeze,'max columns':this.options.max_column_amount});
    ...
    if(this.options.number_of_columns_to_freeze == null){
      ...
      debug.message(this.C_LOG_LVL_ERROR,this.C_PLUGIN_NAME,'Number of columns to freeze is larger than number of all raport columns');
      this._show_error_page_message(this.C_ERROR_MESSAGE.to_much_freeze_col);
  ...
  _destroy: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_destroy');
  },

  _setOption: function( p_key, p_value ) {
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_setOption',{'p_key': p_key,'p_value':p_value});
    if ( p_key === "value" ) {
  ...
  options: function( p_options ){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'options');
    this._super( p_options );
  },

  _setOptions: function( p_options ) {
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_setOptions');
    this._super( p_options );
  },
  _show_error_page_message: function (p_message) { 
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_show_error_page_message');
    //apex.message.clearErrors();
    apex.message.showErrors([
      {
        type:       "error",
        location:   "page",
        message:    this.errorPrefix + p_message,
        unsafe:     false
      }
    ]);
  },
  ...
  _set_freeze_headers_div: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_freeze_headers_div');
  ...
  _set_freeze_div: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_freeze_div');
    var freeze_div  =  
      $('<div></div>')
        .addClass('freeze_div')
        .css({
  ...
  _set_headers_div: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_headers_div');
  ...
  _set_standard_div: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_standard_div');
  ...
  _get_divs: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_get_divs');
  ...
  _get_tdivs: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_get_tdivs',this.new_raport.width());
  ...
  _set_cell_Widths: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_cell_Widths',{'number_of_columns_to_freeze':this.options.number_of_columns_to_freeze, 'width of catch div':this.new_raport.width(), 'width of freeze header div': this.report_divs.freeze_header_div});
  ...
  _set_cell_Heights: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_set_cell_Heights');
  ...
  _delete_last_modify_borders: function(){
    ...
    this.new_raport_table_wrapper.css({
      ...
      "border-color": this.element.css('border-right-color')
    });
    this.new_raport_table_wrapper.find('.standard_div tr td:last-child').css('border-right','none');
  ...
  _find_overflow_element: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_find_overflow_element');
  ...
  _getScrollParent: function(pnode) {
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_getScrollParent');
    if (pnode == null) {
      return null;
    }
  ...
  _add_scrolls: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'f',{'freeze_columns type':this.options.freeze_columns, 'freeze_header type':this.options.freeze_header});
  ...
  _set_border_table_wrap: function(){
    this.new_raport_table_wrapper.css({
      ...
      "border-color": this.report_tdivs.thead.find('.t-Report-report th:first').css('border-left-color'),
      "margin-left": "-1px"
  });
  },
  _scroll_x_header_axis: function(){
    
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_scroll_x_header_axis');
    
      this.scrollElement.scroll($.proxy(function (event) {
        debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_scroll_x_header_axis scroll event',{'event':event});
  ...
  _scroll_y_axis: function(){
    debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_scroll_y_axis',this.plugin_settings);
    ...
    this.plugin_settings.scrollYSelector.on('scroll.'+event_scroll_selector, $.proxy(function(event){
      debug.message(this.C_LOG_LVL_DEBUG,this.C_PLUGIN_NAME,'_scroll_y_axis scroll event',{'event':event});
      ...
      if(this.theadPosition === "fixed"){
        ...
        if(this.plugin_settings.scrollYSelector.scrollTop() + page_header_height > header_offset_top_relative && this.plugin_settings.scrollYSelector.scrollTop() + page_header_height < header_offset_top_relative + tableWrap_height - thead_height){
          ...
          this.report_tdivs.thead.css({
            ...
            "border-bottom-color": this.report_tdivs.thead.find('.t-Report-report th:first').css('border-bottom-color')
          });
          //actualizing scroll
          this.report_divs.header_div.css("left", - this.scrollElement.scrollLeft());
          this.report_divs.freeze_header_div.css("left",0);
  ...
  _throwError: function( p_text ){
    try {
      debug.message(this.C_LOG_LVL_ERROR,this.C_PLUGIN_NAME,'_throwError',{'p_text':p_text});
      throw p_text;
    } catch( p_error ){
      throw p_error;
    }
